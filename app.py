...
from api import GetGenerationList, GetPokemonDetailsAPI, GetAllPokemonBasicAPI, GetTeamStrength, SearchPokemonByName, SearchPokemonByType
...
api.add_resource(GetGenerationList, "/generations")
